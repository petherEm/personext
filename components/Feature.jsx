    ...
    <Container id="feature">
      <Wrapper>
        <Left>
          ...
          <Desc>
            I am digitizing the Payments and Remittance sector in Europe. I am a
            seasoned (14+ years){" "}
            <b>
              Senior Manager in Banking & Finance industry. As a Head of Sales
              and Integrations at Western Union (NYSE: WU)
            </b>
            , I sell and integrate WU payments platform to Financial
            Institutions across EEA countries.
          </Desc>
          <Desc>
        ...
        <Right>
          ...
          <RightInfo>
            ...
            <Desc>
              M.Sc., Banking & Finance, Warsaw School of Economics (2009)
            </Desc>
          </RightInfo>
          ...
          <LangSection>
            <SpeakLang>
              ...
              <RightInfo>
                ...
                <FlagContainer>
                  <Flag code="gb" height="25" />
                </FlagContainer>
                <FlagContainer>
                  <Flag code="fr" height="25" />
                </FlagContainer>
                <FlagContainer>
                  <Flag code="es" height="25" />
                </FlagContainer>
              </RightInfo>
            </SpeakLang>
            <WriteLang>
